...
COPY end_to_end_pipeline_file.py end_to_end_pipeline.py make_reports.py modelos.py prediction.py preprocessing.py report_utils.py utils.py header_deeplesionbrain.png female_vb_bounds.pkl male_vb_bounds.pkl average_vb_bounds.pkl README.pdf /opt/deeplesionbrain/
